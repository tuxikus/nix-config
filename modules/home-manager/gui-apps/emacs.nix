  ...
  config = {
    ...
    home = {
      file = {
        ...
        # salt-mode
        ".emacs.d/snippets/salt-mode/jinja-variable".text = ''
    	# -*- mode: snippet -*-
    	# name: jinja-variable
    	# key: jv
    	# --
        ...
        ".emacs.d/snippets/salt-mode/jinja-statement".text = ''
          # -*- mode: snippet -*-
          # name: jinja-statement
          # key: js
          # --
          {% $0 %}
          '';
    
        ".emacs.d/snippets/salt-mode/jinja-comment".text = ''
          # -*- mode: snippet -*-
          # name: jinja-comment
          # key: jc
          # --
