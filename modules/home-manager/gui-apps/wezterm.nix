  ...
  home.file.".config/wezterm/wezterm.lua" = {
    text = ''
      ...
      config.keys = {
         ...
         { mods = "LEADER", key = "w", action = wezterm.action.ActivateCopyMode },
         { mods = "LEADER", key = "Space", action = wezterm.action.QuickSelect },
         { mods = "LEADER", key = "x", action = wezterm.action.ActivateCommandPalette },
         { mods = "LEADER", key = "c", action = wezterm.action.SpawnTab "CurrentPaneDomain",},
         { mods = "LEADER", key = "k", action = wezterm.action.CloseCurrentPane { confirm = true },},
         { key = "r",
           mods = "LEADER",
