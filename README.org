...
#+begin_src nix :noweb yes
  home = {
    file = {
  	...
  	<<emacs-snippets-salt-mode-jinja-variable>>
  	'';

      ".emacs.d/snippets/salt-mode/jinja-statement".text = ''
        <<emacs-snippets-salt-mode-jinja-statement>>
        '';

      ".emacs.d/snippets/salt-mode/jinja-comment".text = ''
        <<emacs-snippets-salt-mode-jinja-comment>>
  	  '';
    };
  };
#+end_src
...
******* salt-mode
******** jinja-variable
#+name: emacs-snippets-salt-mode-jinja-variable
#+begin_src snippet
  # -*- mode: snippet -*-
  # name: jinja-variable
  # key: jv
...
#+end_src
******** jinja-statement
#+name: emacs-snippets-salt-mode-jinja-statement
#+begin_src snippet
  # -*- mode: snippet -*-
...
#+end_src
******** jinja-comment
#+name: emacs-snippets-salt-mode-jinja-comment
#+begin_src snippet
  # -*- mode: snippet -*-
  # name: jinja-comment
  # key: jc
