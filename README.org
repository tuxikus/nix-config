...
**** restore-home-backup
***** Nix configuration
#+begin_src nix :tangle modules/home-manager/scripts/restore-home-backup.nix :noweb yes :mkdirp yes
  {
    home.file.".local/bin/restore-home-backup" = {
      text = ''
        <<script-restore-home-backup>>
      '';
...
#+end_src
***** Script
#+name: script-restore-home-backup
#+begin_src shell
  #!/usr/bin/env bash
...
**** fpass wl-copy
***** Nix configuration
#+begin_src nix :tangle modules/home-manager/scripts/fpass-wl-copy.nix :noweb yes :mkdirp yes
  {
    home.file.".local/bin/fpass" = {
      text = ''
        <<script-fpass-wl-copy>>
      '';
...
**** Fish
***** Nix configuration
#+begin_src nix :tangle modules/home-manager/shell/fish.nix :noweb yes :mkdirp yes
  {
    programs.fish = {
      enable = true;
