...
#+end_src
**************** Use Keycast with doom modeline
To use keycast-mode-line-mode with doom-modeline use the use-package snippet below. ([[https://github.com/tarsius/keycast/issues/7#issuecomment-2387310012][GitHub]])
#+begin_src emacs-lisp
  (use-package keycast)
